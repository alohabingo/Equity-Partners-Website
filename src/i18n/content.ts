  ...
  en: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "Types of cookies we may use", bullets: ["Strictly necessary cookies needed for the core operation of the site.", "Performance and analytics cookies, set by Google Analytics, which help us understand how the site is used. These are only used if you accept them.", "Functionality cookies that remember your preferences and improve your experience.", "Marketing and advertising cookies, set by Meta (Facebook), which let us measure how our advertising performs and reach people who have shown an interest. These are only used if you accept them."] },
  ...
  es: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "Tipos de cookies que podemos utilizar", bullets: ["Cookies estrictamente necesarias para el funcionamiento básico del sitio.", "Cookies de rendimiento y analítica, instaladas por Google Analytics, que nos ayudan a entender cómo se utiliza el sitio. Solo se utilizan si usted las acepta.", "Cookies de funcionalidad que recuerdan sus preferencias y mejoran su experiencia.", "Cookies de marketing y publicidad, instaladas por Meta (Facebook), que nos permiten medir el rendimiento de nuestra publicidad y llegar a personas que han mostrado interés. Solo se utilizan si usted las acepta."] },
  ...
  ca: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "Tipus de cookies que podem utilitzar", bullets: ["Cookies estrictament necessàries per al funcionament bàsic del lloc.", "Cookies de rendiment i analítica, instal·lades per Google Analytics, que ens ajuden a entendre com s'utilitza el lloc. Només s'utilitzen si vostè les accepta.", "Cookies de funcionalitat que recorden les seves preferències i milloren la seva experiència.", "Cookies de màrqueting i publicitat, instal·lades per Meta (Facebook), que ens permeten mesurar el rendiment de la nostra publicitat i arribar a persones que hi han mostrat interès. Només s\'utilitzen si vostè les accepta."] },
