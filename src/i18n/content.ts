  ...
  es: {
    ...
    cookies: {
      ...
      sections: [
        ...
        { title: "Tipos de cookies que podemos utilizar", bullets: ["Cookies estrictamente necesarias para el funcionamiento básico del sitio.", "Cookies de rendimiento y analítica que nos ayudan a entender cómo se utiliza el sitio.", "Cookies de funcionalidad que recuerdan sus preferencias y mejoran su experiencia.", "Cookies de marketing y publicidad, instaladas por Meta (Facebook), que nos permiten medir el rendimiento de nuestra publicidad y llegar a personas que han mostrado interés. Solo se utilizan si usted las acepta."] },
