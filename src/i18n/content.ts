  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        message: "Share your investment focus and timeline",
        submit: "Send Enquiry",
      },
  ...
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        message: "Comparta su enfoque de inversión y calendario",
  ...
  ca: {
    ...
    contact: {
      ...
      form: {
        ...
        message: "Comparteixi el seu enfocament d'inversió i calendari",
        submit: "Enviar consulta",
      },
